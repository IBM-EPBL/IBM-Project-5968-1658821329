...
conn=ibm_db.connect("DATABASE=bludb;HOSTNAME=55fbc997-9266-4331-afd3-888b05e734c0.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31929;SECURITY=SSL;protocol=tcpip;UID=scs39301;PWD=4pGriU46oCJtoSnD;",'','')
...
def addexpense():
    ...
    if(total>limit[0]):
        ...
        mail_from =  'tusharrravindran@gmail.com'
        ...
        try:
            ...
            server.ehlo()
            server.login('apikey', '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')
